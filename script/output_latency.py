...
best_values = {app: {dataset: {'latency': float('inf')} for dataset in file_datasets} for app in file_applications}
        ...
        for time in times:
            for r1 in r1_values:
                for r2 in r2_values:
                    ...
                    summary_file_path = os.path.join(folder_path, 'latency3.txt')
                    ...
                    try:
                        with open(summary_file_path, 'r') as file:
                            ...
                            #     if f1 > best['f1']:
                            #         best['f1'] = f1
                            if latency > 0 and latency < best['latency']:
