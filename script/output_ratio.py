...
best_values = {app: {dataset: {'money': float('0')} for dataset in file_datasets} for app in file_applications}
        ...
        for time in times:
            for r1 in r1_values:
                for r2 in r2_values:
                    ...
                    summary_file_path = os.path.join(folder_path, 'ratio3.txt')
