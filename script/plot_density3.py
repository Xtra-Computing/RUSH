...
def main():
    transactions = read_increment_file('/data/yuhang/rush/ios/static.txt')
    ...
    burst_fraud_timestamps = identify_burst_fraud_nodes(transactions, fraud_nodes, burst_timestamps)
